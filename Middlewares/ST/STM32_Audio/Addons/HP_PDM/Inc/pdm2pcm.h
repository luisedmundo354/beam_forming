...
#define PDM2PCM_DEC_FACTOR_96         0x0008U
#define PDM2PCM_DEC_FACTOR_64_HI_PERF 0x0009U
#define PDM2PCM_DEC_FACTOR_96_HI_PERF 0x000AU

#define PDM2PCM_BITDEPTH_16           0x0000U
#define PDM2PCM_BITDEPTH_24           0x0001U
#define PDM2PCM_BITDEPTH_24IN32       0x0002U
...
#define PDM2PCM_BITDEPTH_ERROR        0x0100U
#define PDM2PCM_NOT_SUPPORTED_ERROR   0x0200U

#define PDM2PCM_MEMORY_SIZE           25
/**
  * @}
  */
...
typedef struct
{
  ...
  int16_t bit_depth;                                /*!< bit depth configuration. Valid values: 16, 24, 32 bit */
} PDM2PCM_Config_t;
